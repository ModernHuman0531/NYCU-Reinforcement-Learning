...
class Actor(nn.Module):
    def __init__(self, hidden_size, num_inputs, action_space):
        ...
        The structure is:
        num_inputs -> 256 -> 256 -> num_outputs
...
class Critic(nn.Module):
    def __init__(self, hidden_size, num_inputs, action_space):
        ...
        The structure is:
        (num_inputs + num_outputs) -> 256 -> 256 -> num_outputs
...
class DDPG(object):
    ...
    def select_action(self, state, action_noise=None):
        ...
        if action_noise is not None:
            ...
            clip_mu = torch.clamp(mu, min=-2.0, max=2.0)
...
def train():    
    ...
    lr_a = 3e-4               # actor lr for stability
    lr_c = 3e-4               # critic lr
...
if __name__ == '__main__':
    ...
    # train()
    test(actor_path='preTrained/ddpg_actor_Pendulum-v1_ep349_score-123.5.pth', critic_path='preTrained/ddpg_critic_Pendulum-v1_ep349_score-123.5.pth')
